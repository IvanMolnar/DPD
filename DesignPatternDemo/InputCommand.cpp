...
//	Input::addText("----------- Select option -----------", 0);
	...
	Input::addInputAction(inputAction('w', "North", Events::walk, Directions::North, GameStates::Unchanged, 0, 0));
	Input::addInputAction(inputAction('s', "South", Events::walk, Directions::South, GameStates::Unchanged, 0, 0));
	Input::addInputAction(inputAction('a', "West", Events::walk, Directions::West, GameStates::Unchanged, 0, 0));
	Input::addInputAction(inputAction('d', "East", Events::walk, Directions::East, GameStates::Unchanged, 0, 0));
